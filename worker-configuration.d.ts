/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9b6c2b4cc1b451c8cc0c947264611df)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	HHGOA_KV: KVNamespace;
	ASSETS: Fetcher;
	ADMIN_PASSWORD: string;
	FORM_WEBHOOK_SECRET: string;
	RATE_LIMITER_DO: DurableObjectNamespace<import("./custom-worker").RateLimiterDO>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASSWORD" | "FORM_WEBHOOK_SECRET">> {}
}
